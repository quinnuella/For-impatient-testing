...
document.addEventListener('DOMContentLoaded', () => {  
  // then method call with rejection handler
  {
    ...
    const url = 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Hanafuda_June_Tane_Alt.svg/76px-Hanafuda_June_Tane_Alt.svg.png'    
    loadImage(url)
      .then(
  ...
  // Pipeline with single catch
  {
    ...
    const url1 = 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Hanafuda_June_Tane_Alt.svg/76px-Hanafuda_June_Tane_Alt.svg.png'    
    const url2 = 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Hanafuda_June_Tane_Alt.svg/76px-Hanafuda_June_Tane_Alt.svg.png'    
    Promise.resolve()
      .then(() => loadImage(url1))
